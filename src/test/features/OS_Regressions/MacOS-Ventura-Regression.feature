...
Feature: Automation of ventura machine with different browsers.
  ...
  Scenario Outline: User is able to run local test session and run session with tunnel for ventura browser with network true
    ...
    @ireland_smoke @sydney_smoke_new
    Examples:
      | capabilities                                                                                                                                                                          |
  ...
  Scenario Outline: Network logs, console & selenium logs should be generated and visible on UI for ventura browser with tunnel true
    Given Setup user details
    Then I start tunnel
